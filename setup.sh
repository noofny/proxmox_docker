...
wget -qL https://raw.githubusercontent.com/noofny/proxmox_docker/master/setup_os.sh
...
# Setup docker
info "Fetching setup script..."
wget -qL https://raw.githubusercontent.com/noofny/proxmox_docker/master/setup_docker.sh
info "Executing script..."
cat ./setup_docker.sh
